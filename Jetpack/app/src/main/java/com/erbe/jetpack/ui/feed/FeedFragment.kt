...
import com.erbe.jetpack.ui.feed.blog.BlogFragment
import com.erbe.jetpack.ui.feed.opensource.OpenSourceFragment
...
class FeedFragment : Fragment(), FeedViewModel.OpenSourceItemClickHandler {
    ...
    inner class FeedPagerAdapter(fragmentManager: FragmentManager) :
