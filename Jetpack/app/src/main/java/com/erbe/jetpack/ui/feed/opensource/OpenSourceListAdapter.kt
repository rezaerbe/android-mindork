...
import com.erbe.jetpack.databinding.ItemNetworkBinding
import com.erbe.jetpack.databinding.ItemOpenSourceViewBinding
...
class OpenSourceListAdapter(val handler: OpenSourceViewModel.OpenSourceItemClickHandler) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_ITEM) {
            val itemBinding = ItemOpenSourceViewBinding.inflate(
